## creatChatRoom GUI for joining a group Chat Hub
...
class groupChat(QWidget):
    ...
    def layoutUI(self, client, chattingWith, previousPage):
        ...
        self.setWindowTitle("This is a group chat! Beep Boop ~")
        self.setWindowIcon(
            QIcon(
    ...
    def customise(self):
        ...
        self.chattingWith.setStyleSheet(
            "QLabel {font: 12pt; color: rgb(255, 255, 255); background-color: rgb(19,19,19); padding: 20px;}"
        )
        self.messageBox.setStyleSheet(
            "QLineEdit {font: 12pt; color: rgb(255, 255, 255); background-color: rgb(51,51,51); padding: 20px;}"
        )
        self.chatWindow.setStyleSheet(
            "QTextEdit {font: 12pt; color: rgb(255, 255, 255); background-color: rgb(19,19,19); padding: 20px;}"
        )
